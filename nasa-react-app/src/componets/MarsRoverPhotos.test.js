...
describe('MarsRoverPhotos', () => {
  ...
  const photos = [
    { id: 1, img_src: 'https://testurl.com/photo1.jpg', earth_date: '2023-02-19' },
    { id: 2, img_src: 'https://testurl.com/photo2.jpg', earth_date: '2023-02-19' }
  ];
  ...
  test('renders photos correctly', async () => {
    render(<MarsRoverPhotos earth_date="2023-02-19" />);
